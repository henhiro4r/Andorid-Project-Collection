...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    EditText edtOnceMessage, edtRepeatMessage;
    ImageButton btnOnceDate , btnOnceTime, btnRepeatTime;
    Button btnSetOnce, btnSetRepeat, btnCancelRepeat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvOnceTime = findViewById(R.id.tv_once_clock);
        tvRepeatTime = findViewById(R.id.tv_repeat_time);
        edtOnceMessage = findViewById(R.id.edt_once_message);
        edtRepeatMessage = findViewById(R.id.edt_repeat_message);
        ...
        btnSetOnce = findViewById(R.id.btn_set_time_alarm);
        btnSetRepeat = findViewById(R.id.btn_set_repeat_alarm);
        btnCancelRepeat = findViewById(R.id.btn_cancel_repeat_alarm);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_set_repeat_alarm:
                break;
            case R.id.btn_cancel_repeat_alarm:
                break;
        }
    }
